...
func main() {
	...
	gocron.Every(1).Day().At("20:45").Do(controllers.TotalDns, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("20:45").Do(controllers.TotalBlock, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("20:45").Do(controllers.TotalDnsBlock, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("20:45").Do(controllers.TotalIpAdress, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("20:45").Do(controllers.TotalMostActiveList, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("20:45").Do(controllers.TotalDnsDayList, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("20:45").Do(controllers.TotalIpAddressDayList, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("20:45").Do(controllers.BlockList, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("18:40").Do(controllers.TotalRequestList, dbConn, redisConn)
