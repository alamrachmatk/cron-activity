...
func main() {
	...
	gocron.Every(1).Day().At("12:00").Do(controllers.TotalBlock, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("12:00").Do(controllers.TotalDnsBlock, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("12:00").Do(controllers.TotalIpAdress, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("12:00").Do(controllers.TotalMostActiveList, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("12:00").Do(controllers.TotalIpAddressDayList, dbConn, redisConn)
	...
	gocron.Every(1).Day().At("12:00").Do(controllers.TotalRequestList, dbConn, redisConn)
